...
const FilterStateLabel = React.memo(({ filterState }: Props) => {
  switch (filterState) {
    ...
    case "active":
      return <span>Active Transactions, 10 most recent</span>
    ...
    case "completed":
      return <span>Completed Transactions, 10 most recent</span>
    case "completed-and-text":
      return <span>Completed Transactions, filtered by user input</span>
    case "rejected":
      return <span>Rejected Transactions, 10 most recent</span>
